      ...
      <div className="container">
        <div className="mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto w-full max-w-lg text-center">
            ...
            <p className="md:text-md">
              From a partner who understands the Caribbean market
            </p>
          </div>
        </div>
        <div className="gid-cols-1 grid gap-6 sm:grid-rows-4 md:grid-cols-2 md:gap-8 lg:grid-cols-4 lg:grid-rows-2">
          ...
          <div className="flex flex-col items-start justify-between border border-border-primary p-6 sm:col-span-2 md:p-8">
            ...
            <p className="md:text-md">
              "We stopped losing deals to competitors the moment we switched to
              interactive proposals. Our close rate jumped 34% in the first
              quarter, and clients actually tell us they appreciate the
              professionalism."
            </p>
            <div className="mt-5 flex w-full flex-col items-start md:mt-6 md:w-fit md:flex-row md:items-center">
              ...
              <div>
                ...
                <p>Managing Director, Caribbean Digital Solutions</p>
              </div>
            </div>
          </div>
          <div className="flex items-center justify-center border border-border-primary p-6 md:p-8 lg:p-6">
